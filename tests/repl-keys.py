...
STEPS = [
    ...
    (b"\x1b\x1b[A", "Option-Up (meta arrow, scroll back)"),
    (b"\x1b\x1b[B", "Option-Down"),
    (b"\x1b[5~", "Fn-Up / PageUp (half screen back)"),
    (b"\x1b[6~", "Fn-Down / PageDown"),
    (b"\x02", "Ctrl-B (scroll back a screen)"),
    (b"\x06", "Ctrl-F (scroll forward)"),
    (b"\x06\x06", "Ctrl-F past the bottom"),
